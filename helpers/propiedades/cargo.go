...
func GetCargo(idTercero string) (cargo []map[string]interface{}, outputError map[string]interface{}) {
	...
	urlVinculacion := beego.AppConfig.String("TercerosService") + "vinculacion?limit=1"
	...
	urlParametro := beego.AppConfig.String("ParametroService") + "parametro/" + fmt.Sprintf("%v", idCargo[0]["CargoId"])
